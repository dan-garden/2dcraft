...
export class BiomeGenerator {
  ...
  private registerBiomeBlockRules(): void {
    ...
    this.worldGenerator.registerGenerationRule({
      id: -1, // Placeholder, will be replaced by actual biome's surface block
      name: 'biome_surface',
    ...
    this.worldGenerator.registerGenerationRule({
      id: -1, // Placeholder, will be replaced by actual biome's subsurface block
    ...
    this.worldGenerator.registerGenerationRule({
      id: -1, // Placeholder, will be replaced by actual biome's stone block
      name: 'biome_stone',
